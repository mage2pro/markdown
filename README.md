The «[**Markdown Editor**](https://mage2.pro/c/extensions/markdown)» extension for Magento 2 allows you to format the store's content (product descriptions, articles, CMS blocks and so on) with Markdown markup language.
...
## How to buy
You can buy it with PayPal [here](https://mage2.pro/t/160).  
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/markdown).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/markdown).
